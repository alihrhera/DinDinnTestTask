...
import ali.hrhera.dindinntestapp.view.viewmodel.DrinksViewModel
...
class DrinksFragment : Fragment(),MavericksView {

    private val model: DrinksViewModel by activityViewModel()
